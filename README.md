...
(./Images/01-homepage.png)![The home page shows a search bar with the ability to select a format from a dropdown menu.]

The following image demonstrates the search results page's appearance and functionality:

(./Images/02-search-results-page.png)![The search results page displays results from a search conducted in the form on the left side of the page.]
---
